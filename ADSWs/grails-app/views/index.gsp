...
<head>
	...
	<title>Bienvenido a labmmba! </title>
...
zoom: 88%; " class="landing">

<header id="header">
	<h1><asset:image href="http://www.labmmba.utfsm.cl/"  width="180" height="auto" src="grails_logo.png" alt="Grails"/></>
</h1>
	<nav id="nav">

		<ul>
			<li><a href="http://localhost:8080/ADSW">Inicio</a></li>
